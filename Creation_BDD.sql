...
CREATE TABLE EVENEMENT (
  idevent VARCHAR(42)  NOT NULL,
  dateEvent DATE,
  effectif_min NUMERIC(10),
  effectif_max NUMERIC(10),
  idcontrib VARCHAR(42),
  idtheme VARCHAR(42),
